...
create table rumor_tb(
	...
	content text comment '内容',
	source varchar(60) comment '出处',
	reality varchar(60) comment '真实否'
);
/*食疗表(food_tb)*/
...
('夏季吃羊肉的五大禁忌','51健康助手','2017-09-18 08:00:00','http://47.102.155.48:8080/pic_medicineapp/yu.png','1.忌冷；2.极寒',1,1,100),
('夏季吃羊肉的五大禁忌','51健康助手','2017-09-18 08:00:00','http://47.102.155.48:8080/pic_medicineapp/yu.png','1.忌冷；2.极寒',1,1,100),
('夏季吃羊肉的五大禁忌','51健康助手','2017-09-18 08:00:00','http://47.102.155.48:8080/pic_medicineapp/yu.png','1.忌冷；2.极寒',1,1,100),
('夏季吃羊肉的五大禁忌','51健康助手','2017-09-18 08:00:00','http://47.102.155.48:8080/pic_medicineapp/yu.png','1.忌冷；2.极寒',1,1,100),
('夏季吃羊肉的五大禁忌','51健康助手','2017-09-18 08:00:00','http://47.102.155.48:8080/pic_medicineapp/yu.png','1.忌冷；2.极寒',1,1,100),
('春季吃羊肉的五大禁忌','51健康助手','2017-09-18 08:00:00','http://47.102.155.48:8080/pic_medicineapp/yu.png','1.忌冷；2.极寒',1,0,100),
('冬至吃羊肉的五大禁忌','51健康助手','2017-09-18 08:00:00','http://47.102.155.48:8080/pic_medicineapp/yu.png','1.忌冷；2.极寒',0,3,100),
('老年人吃羊肉的五大禁忌','51健康助手','2017-09-18 08:00:00','http://47.102.155.48:8080/pic_medicineapp/yu.png','1.忌冷；2.极寒',2,2,100);
insert into medicine_tb(name,nickname,image,funs,taboos) values
('八月瓜','木瓜','http://47.102.155.48:8080/pic_medicineapp/medicine1.png','用法：煎汤，3-10g；或入丸，散。外用，煎水洗；或研磨调涂','祛风散热，除湿止痛'),
('当归','木瓜','http://47.102.155.48:8080/pic_medicineapp/medicine2.png','用法：煎汤，3-10g；或入丸，散。外用，煎水洗；或研磨调涂','祛风散热，除湿止痛'),
('艾草','艾蒿','http://47.102.155.48:8080/pic_medicineapp/medicine3.png','用法：煎汤，3-10g；或入丸，散。外用，煎水洗；或研磨调涂','祛风散热，除湿止痛');
...
('三金双黄连口服液可以治疗肺炎','http://47.102.155.48:8080/pic_medicineapp/yu.png','三金双黄连口服液可以治疗肺炎','百度辟谣','true'),
('抽烟可以治疗肺炎','http://47.102.155.48:8080/pic_medicineapp/yu.png','抽烟可以治疗肺炎','阿里辟谣','false');
